...
public class XMLConfiguration implements Configuration {
  ...
  public XMLConfiguration(InputStream src) throws LoadSingleHhResumeException {
    if (src == null) throw new LoadSingleHhResumeException("Не могу найти конфигурационного файла xml.");
    try {
      init(src);
    } catch(SAXException e) {
      throw new LoadSingleHhResumeException("Не могу распарсить конфигурационный файл xml.");
    }catch(IOException e) {
      throw new LoadSingleHhResumeException("Не могу распарсить конфигурационный файл xml.");
